...
class Scheduling extends Baseline_controller {
  ...
  public function index(){
    ...
    $this->page_data['content'] = "<div><a href='".base_url()."index.php/scheduling/test/'>Link</a></div>";
    $this->page_data['page_header'] = "test page";
